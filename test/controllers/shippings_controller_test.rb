...
class ShippingsControllerTest < ActionController::TestCase
  ...
  test "should create shipping" do
    assert_difference('Shipping.count') do
      post :create, shipping: { address: @shipping.address, cost: @shipping.cost, payment: @shipping.payment, status: @shipping.status }
    end
  ...
  test "should update shipping" do
    patch :update, id: @shipping, shipping: { address: @shipping.address, cost: @shipping.cost, payment: @shipping.payment, status: @shipping.status }
    assert_redirected_to shipping_path(assigns(:shipping))
  end
